...
export default function IklanAtas({ data }) {
    ...
    const handleSubmit = (e) => {
        ...
        router.post("/admin/banner-iklan/iklan-bawah", formData);
        setImage(null);
    };

    const TABLE_HEAD = ["Iklan Bawah", ""];
        ...
        <>
            ...
            <Card className="h-full w-full overflow-scroll">
                <table className="w-full min-w-max table-auto text-left">
                    ...
                    <tbody>
                        {data
                            .filter((item) => item.kategori === "iklan-bawah") // Ganti "Iklan Atas" dengan kategori yang sesuai untuk masing-masing komponen
                            .map((banner, i) => (
