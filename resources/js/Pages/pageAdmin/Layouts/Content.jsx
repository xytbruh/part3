        ...
        <Authenticated>
            <div className="w-full  bg-gray-600">
                <div className="flex flex-no-wrap">
                    {/* Sidebar starts */}
                    <div className="absolute lg:relative shadow bg-gray-800 hidden lg:block">
                    ...
                    >
                        ...
                        />
                        <div className="absolute z-40 sm:relative w-64 md:w-96 shadow pb-4 bg-gray-800 lg:hidden transition duration-150 ease-in-out h-full">
                    ...
                    <div className="w-full">
                        {/* Navigation starts */}
                        <nav className="h-16 flex items-center lg:items-stretch justify-end lg:justify-between bg-gray-800 shadow relative z-10">
                            <div className="hidden lg:flex w-full pr-6">
                                <div className="w-1/2 h-full hidden lg:flex items-center pl-6 pr-24">
                                    <div className="relative w-full">
                                        ...
                                        <input
                                            className="border border-gray-800 focus:outline-none focus:border-gray-800 rounded w-full text-sm text-gray-500 bg-gray-100 pl-12 py-2"
                                            type="text"
                                            placeholder="Search"
                                        />
                                    </div>
                                ...
                                <div className="w-1/2 hidden lg:flex">
                                    <div className="w-full flex items-center pl-8 justify-end">
                                        <div className="h-full w-20 flex items-center justify-center border-r border-l border-gray-700">
                                        ...
                                        <div className="h-full w-20 flex items-center justify-center border-r border-gray-700 mr-4 cursor-pointer text-white">
                                            <svg
                                                xmlns="http://www.w3.org/2000/svg"
                                                className="icon icon-tabler icon-tabler-messages"
                                                width={28}
                                            ...
                                            <div className="rounded-full">
                                                {profile ? (
                                                    <ul className="p-2 w-full border-r bg-white absolute rounded left-0 shadow mt-12 sm:mt-16 ">
                                                        <li className="flex w-full justify-between text-gray-900 hover:text-indigo-700 cursor-pointer items-center">
                                                            <Link
                                                                href={route(
                                                                    "profile.edit"
                                                                )}
                                                ...
                                                <div className="relative">
                                                    <img
                                                        ...
                                                        alt="avatar"
                                                    />
                                                    <div className="w-2 h-2 rounded-full bg-green-400 border border-900 absolute inset-0 mb-0 mr-0 m-auto" />
                                                </div>
                                            </div>
