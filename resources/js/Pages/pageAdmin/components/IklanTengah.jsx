...
export default function IklanAtas({ data }) {
    ...
    const handleSubmit = (e) => {
        ...
        router.post("/admin/banner-iklan/iklan-tengah", formData);
        setImage(null);
    };

    const TABLE_HEAD = ["No", "Iklan Atas", ""];
        ...
        <>
            ...
            <Card className="h-full w-full overflow-scroll">
                <table className="w-full min-w-max table-auto text-left">
                    ...
                    <tbody>
                        {data
                            .filter((item) => item.kategori === "iklan-tengah") // Ganti "Iklan Atas" dengan kategori yang sesuai untuk masing-masing komponen
                            .map((banner, i) => (
